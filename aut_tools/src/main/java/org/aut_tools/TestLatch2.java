...
public class TestLatch2 {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    TestLatch2 latchTest = new TestLatch2();
...
class CounterTask implements Runnable {
  ...
  public void run() {
    ...
    System.out.println(
        Thread.currentThread().getName() + " - " + System.currentTimeMillis() + " is ready...");
    ...
    System.out.println(
        Thread.currentThread().getName() + " - " + System.currentTimeMillis() + " started...");
