...
public class FormatCode {
	...
	public static String format(String fileContent) throws Exception {
		...
		try {
			...
			// format
			TextEdit edits = codeFormatter.format(CodeFormatter.K_COMPILATION_UNIT, sourceCode, 0, sourceCode.length(),
					0, null);
			edits.apply(doc);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] arg) {
		String javaCodeBefore = "public class aa {public void aa(){System.out.println(\"aa\");}}";
