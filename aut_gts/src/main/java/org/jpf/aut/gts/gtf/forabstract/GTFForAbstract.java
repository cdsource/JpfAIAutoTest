 ...
 * @version 创建时间：2018年3月6日 上午11:33:03 类说明
 */

package org.jpf.aut.gts.gtf.forabstract;
...
public class GTFForAbstract extends AbstractGenerateTests {
   ...
   * (non-Javadoc)
   * 
   * @see org.jpf.unittests.generateuts.GenerateTests#addExtraBasic(java.lang.String,
   * org.jpf.unittests.generateuts.JpfUtInfo)
   */
  @Override
