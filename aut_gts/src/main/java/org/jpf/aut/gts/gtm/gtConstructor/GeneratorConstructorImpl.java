...
public class GeneratorConstructorImpl implements IGTMForConstructor {
    ...
    public void doGenerate(MethodDeclaration[] methodDec, String strClass, JpfUtInfo cJpfUtInfo)throws Exception {
        ...
        if (cJpfUtInfo.getUtMinConstructor().length() == 0 && cJpfUtInfo.getUtPrivateConstructor().length()==0) {
            cJpfUtInfo.setUtMinConstructor("  " + strClass + " wupf_fixture = new " + strClass + "();");
        }
    }
     ...
     */
    private void getSingletonInstance(MethodDeclaration method, String strClass, JpfUtInfo cJpfUtInfo) throws Exception{
        ...
        sbPrivateConstructor.append("    ").append(strClass).append(" wupf_fixture=").append(strClass).append(".")
        ...
        logger.debug(sbPrivateConstructor);
    ...
    private void addConstructorMethodBody(int Modifiers, String strClass, String strMethodName, List MethodParam,
            JpfUtInfo cJpfUtInfo) throws Exception{
        ...
        cJpfUtMethodInfo.setMethodAssert("    assertNotNull(wupf_result);\n");
    ...
    private String analyseConstructor(int Modifiers, String strClass, String strMethod, List MethodParam,
        ...
        sbConstructor.append("    ").append(strClass).append(" wupf_result = new ").append(strClass);
     ...
     */
    public StringBuffer addConstructorParamInit(List MethodParam, JpfUtInfo cJpfUtInfo)throws Exception {
