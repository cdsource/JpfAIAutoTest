...
package org.jpf.aut.gts.plugins.springs.gtm;
...
public class GTMForDAOInterface extends AbstractGenerateMethod {
    ...
    public String addClassInstance(String strClassName, List MethodParam, JpfUtInfo cJpfUtInfo) {
        ...
        cJpfUtInfo.addImport(" import org.jpf.aitest.selftest.JpfTestInfo;");
        cJpfUtInfo.addImport(" import org.jpf.aitest.selftest.abstractJpfSelfTest;");
        return "";
    }
