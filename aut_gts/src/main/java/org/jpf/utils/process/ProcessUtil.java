/**
 * copyrigth by wupf@asiainfo.com 2018年9月12日
 */
package org.jpf.utils.process;
...
public class ProcessUtil {
  ...
  public static void runexec(String strStartPath, String strCmd, StringBuffer sbError)
      throws Exception {
    if (JpfOsUtil.getInstance().isWindows()) {
  ...
  public static void runCmd(String strStartPath, String strCmd) throws Exception {
    ...
    try {
      ...
      if (strStartPath == null) {
        ...
        strCmd =
            "cmd /c " + strStartPath.substring(0, 2) + " && cd " + strStartPath + "  && " + strCmd;
      }
      logger.info(strCmd);
          ...
          try {
            ...
            while ((line = br.readLine()) != null) {
              if (line.indexOf("evosuite") < 0)
                 ...
                 * !line.equalsIgnoreCase("[ERROR] There are test failures.")) { logger.error(line);
   ...
   * @throws Exception 2018年8月26日
   */
  public static void runShell(String strPomFilePath, String strCmd, StringBuffer sbError)
      throws Exception {
    try {
      sbError.setLength(0);
      String[] cmd = null;
