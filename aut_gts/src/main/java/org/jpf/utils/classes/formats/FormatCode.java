 ...
 */
package org.jpf.utils.classes.formats;
...
public class FormatCode {
  ...
  public static void formatJavaCode(String fileName) throws Exception {
    ...
    String fileContent = JpfFileUtil.getFileTxt(fileName, GenerateInputParam.JAVA_ENCODE);
    fileContent = format(fileContent);
    JpfFileUtil.saveFile(fileName, fileContent, GenerateInputParam.JAVA_ENCODE);
  }
