/**
 * copyrigth by wupf@aliyun.com 2018年8月22日
 */
...
public class JpfClassUtils {
  ...
  public void doWork() {
    ...
    try {
      ...
      if (!JpfFileUtil.FileExist(strAddPath)) {
      ...
      // InputStream is = classLoader.getResourceAsStream("com.zmcc.adcloud.data.dto.UserPermission"
      // + ".class");
      ...
      try {
        if (is == null)
          throw new NullPointerException(
              "Class not found " + "com.zmcc.adcloud.data.dto.UserPermission");
        else
          logger.info(is);
      } finally {
        if (is != null)
