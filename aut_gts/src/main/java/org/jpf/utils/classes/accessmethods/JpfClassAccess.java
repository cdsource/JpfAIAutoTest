...
import org.jpf.aut.format.utils.FormatCode;
...
public class JpfClassAccess {
  ...
  public void ChangeMethodAccess(String strFileName) {
    try {
      ...
      // get method pos
      CompilationUnit cu =
          ParseJavaByJdt.getInstance().parseJavaSourceFile18(strFileName, "GBK");
      ...
      for (MethodDeclaration method : methodDec) {
        ...
        if (method.getModifiers() == 2) {
          ...
          logger.info("start line:" + JavaFileTexts[iMethodStartRow - 1]);
          logger
              .info("end line:" + cu.getLineNumber(mBlock.getStartPosition() + mBlock.getLength()));
