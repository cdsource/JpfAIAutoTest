...
public class FormatUtil {
     ...
     */
    public static void formatToParamBody(MethodParamBody cParamInitBody, String strParamName) {
    ...
    public static String getParamVar(List MethodParam) {
        MethodParamBody cParamInitBody = new MethodParamBody(MethodParam.get(0).toString());
