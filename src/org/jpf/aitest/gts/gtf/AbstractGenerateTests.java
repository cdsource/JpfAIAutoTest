...
package org.jpf.aitest.gts.gtf;
...
import org.jpf.aitest.gts.gtm.AbstractGenerateMethod;
import org.jpf.aitest.gts.gtm.GenerateMethodPrivate;
import org.jpf.aitest.gts.gtm.GenerateMethodPublic;
import org.jpf.aitest.gts.gtm.GenerateMethodPublicStatic;
import org.jpf.aitest.gts.gtm.gtConstructor.GeneratorConstructorImpl;
import org.jpf.aitest.plugins.gts.springs.gtm.GTMForDAOInterface;
import org.jpf.aitest.utils.AddImport;
...
public abstract class AbstractGenerateTests {
    ...
    private boolean doCheckDate(String sFileName )
    {
    ...
    public boolean doGenerateFile(String strFileName) {
        ...
        if (getUTSavePath()!=null && getUTSavePath().length() > 0) {
            strSaveUtFileName = getUTSavePath() + "\\"
