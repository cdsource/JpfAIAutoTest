  ...
  <scope>test</scope>
	...
	private void doWork(String strPrjPath) {
		...
		try {
    		...
    		//-DmemoryInMB=2000 -Dcores=4 
			String strCmd="cmd /c "+strPrjPath.substring(0,2) +" && cd "+strPrjPath+"  &&  mvn evosuite:generate evosuite:export && mvn evosuite:info";
			runexec(strCmd);
