...
package org.jpf.aitest.plugins.gts.springs.gtm;

import java.util.List;

import org.jpf.aitest.JpfUtInfo;
import org.jpf.aitest.gts.gtm.AbstractGenerateMethod;
import org.jpf.aitest.plugins.gts.springs.Service2Bean;


/**
 * 
 */
public class GTMForDAOInterface extends AbstractGenerateMethod {

    /**
     * 
     */
    public GTMForDAOInterface() {
    ...
    public String addClassInstance(String strClassName, List MethodParam, JpfUtInfo cJpfUtInfo) {
        ...
        cJpfUtInfo.addImport(" import com.asiainfo.aitest.selftest.JpfTestInfo;");
        cJpfUtInfo.addImport(" import com.asiainfo.aitest.selftest.abstractJpfSelfTest;");
        return "";
    }
