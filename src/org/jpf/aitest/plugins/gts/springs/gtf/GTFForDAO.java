...
package org.jpf.aitest.plugins.gts.springs.gtf;
...
import org.jpf.aitest.plugins.gts.springs.SpringsInputParam;

/**
 * 
 */
public class GTFForDAO   extends AbstractGenerateTests{
    ...
    protected  String addClassDeclare(String strClass) {
        ...
        if (null != SpringsInputParam.UT_ExtendClassName && SpringsInputParam.UT_ExtendClassName.trim().length() > 0) {
	...
	public void setNewPackage(JpfUtInfo cJpfUtInfo) {
		// TODO Auto-generated method stub	
		cJpfUtInfo.setUtPackage(SpringsInputParam.New_Package_Name+"\n//"+cJpfUtInfo.getUtPackage());
	}
