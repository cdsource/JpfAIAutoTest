...
import org.jpf.aitest.plugins.springs.logs.HandleLogFromDebug;
    ...
    public void HandleLogFile(String strFileName, int iFileCount) throws Exception {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                int iPos = line.indexOf(HandleLogInputParam.KEY_SelfTest_Method);
                if (iPos > 0) {
                    line=line.substring(iPos+HandleLogInputParam.KEY_SelfTest_Method.length()+1,line.length());
                ...
                iPos = line.indexOf(HandleLogInputParam.KEY_SQL_STATEMENT);

                if (line.indexOf(HandleLogInputParam.KEY_SQL) > 0 && iPos > 0 && isFindSql) {
