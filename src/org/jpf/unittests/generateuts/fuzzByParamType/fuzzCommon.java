...
public class fuzzCommon implements IFuzz {
     ...
     */
    private CompilationUnit getClassCompilationUnit(ParamInitBody cParamInitBody, JpfUtInfo cJpfUtInfo) {
    ...
    public StringBuffer getClassSetMethodInit( TypeDeclaration typeDec, String PackageName,
            ParamInitBody cParamInitBody, JpfUtInfo cJpfUtInfo) {
        ...
        try {
            ...
            for (MethodDeclaration method : methodDec) {
                ...
                List<ParamInitBody> parameters =new ArrayList<ParamInitBody>();
