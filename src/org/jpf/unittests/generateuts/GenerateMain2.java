...
public class GenerateMain2 {
     ...
     * 
     */
    public GenerateMain2(String strInputFile) {
            ...
            if (AiFileUtil.isDirectory(strInputFile)) {
                ...
                while (vFiles.size() > 0) {
                    if (GenerateInputParam.FileNameFilter.length() > 0) {
                        ...
                        if (m.find())
                        {
                            if (cGenerateUnitTests.doGenerateFile(strFileName)) {
                                GenerateConst.iGenFileCount++;
                            }
                        }
                    } else {
        ...
        logger.info("生成测试文件个数 " + GenerateConst.iGenFileCount);
    ...
    public static void main(String[] args) {
        ...
        strFileName = "D:\\svn\\ecommerce-branch-20170912\\app-dao\\src\\main\\java\\com\\asiainfo\\ebiz\\alipay";
        // strFileName =
        // "F:\\svn\\svn10.1.195.110\\trunk\\code-res\\templateInteApi\\templateCommon\\src\\main\\java\\com";
        new GenerateMain2(strFileName);
    }
